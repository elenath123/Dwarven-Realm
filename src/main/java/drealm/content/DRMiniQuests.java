...
public class DRMiniQuests {
	...
	private static void setupMiniQuestFactories() {
		...
		DRAPI.addMiniQuest(windMountains, new LOTRMiniQuestKillFaction.QFKillFaction(KILL_MORDOR).setKillFaction(LOTRFaction.GONDOR, 20, 40));
		DRAPI.addMiniQuest(windMountains, new LOTRMiniQuestKillFaction.QFKillFaction(KILL_ORC).setKillFaction(LOTRFaction.WOOD_ELF, 20, 40));
		DRAPI.addMiniQuest(windMountains, new LOTRMiniQuestKillFaction.QFKillFaction(KILL_WARG).setKillFaction(LOTRFaction.DORWINION, 20, 40));
